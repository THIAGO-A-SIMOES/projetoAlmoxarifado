...
public class Cadastro_Categoria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pprincipal.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Categoria", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12))); // NOI18N
    ...
    private void cadastro() {
            ...
            String sql = "insert into categoria (descricao, situacao)";
            sql += "values (?, ?)";
            ...
            try {
                ...
                ps.setInt(2, categoria.getSituacao());
                ps.execute();
                ...
                Logger.getLogger(Cadastro_Categoria.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Categoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
