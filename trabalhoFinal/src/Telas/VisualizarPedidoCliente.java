...
public class VisualizarPedidoCliente extends javax.swing.JFrame {
    ...
    public VisualizarPedidoCliente() {
        initComponents();
    ...
    protected List<PedidoCliente> listpedidocliente;
        ...
        try {
            ...
            String sql2 = "select * from pedidoCliente ";
    ...
    private void jbcadastrar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbcadastrar2ActionPerformed
        Cadastro_PedidoCliente cp = new Cadastro_PedidoCliente();
        dispose();
        cp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarPedidoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizarPedidoCliente().setVisible(true);
            }
        });
    }
